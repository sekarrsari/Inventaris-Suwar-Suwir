            ...
            <div class="flex-none w-full max-w-7xl px-3 py-6">
                <div
                    ...
                    <div class="p-6 pb-0 m-6 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h2 class="text-3xl font-bold mb-9">Form Edit Data Penjualan</h2>
                        ...
                        <div class="flex-auto px-0 pt-0 pb-2">
                            ...
                            @endif
                                ...
                                <form action="{{ route('penjualan.update', $dataPenjualan->id) }}" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-7 items-center w-full mb-0 align-top border-collapse">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div>
                                        ...
                                        <select name="bulan" id="bulan" required
                                            ...
                                            @foreach($bulanList as $bulan_item)
                                                <option value="{{ $bulan_item }}" {{ old('bulan', $dataPenjualan->bulan ?? '') == $bulan_item ? 'selected' : '' }}>
                                                    {{ $bulan_item }}
                                                </option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div>
                                        ...
                                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5 
                                        placeholder="YYYY"
                                        value="{{ old('tahun', $dataPenjualan->tahun) }}"
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="jumlah_ori" id="jumlah_ori" value="{{ old('jumlah_ori', $dataPenjualan->jumlah_ori) }}" required
                                            class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                            placeholder="0">
                                            @error('jumlah_ori')
                                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="jumlah_rasa" id="jumlah_rasa" value="{{ old('jumlah_rasa', $dataPenjualan->jumlah_rasa) }}" required
                                            class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                            placeholder="0">
                                            @error('jumlah_rasa')
                                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
