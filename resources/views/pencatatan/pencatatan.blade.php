                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex justify-between items-center mt-3 mb-12">
                            ...
                            <div class="flex items-center">
                                <button type="button"
                                    onclick="window.location.href='./pencatatan/create'"
                            ...
                            <table
                                ...
                                <thead class="text-base font-semibold text-black bg-gray-200">
                                    <tr>
                                        ...
                                        <th scope="col" class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-collapse shadow-none border-b-solid tracking-none whitespace-nowrap">Harga Satuan</th>
                                        <th scope="col" class="px-6 py-3 font-bold text-left align-middle bg-transparent border-b border-collapse shadow-none border-b-solid tracking-none whitespace-nowrap">Total Harga</th>
                                ...
                                <tbody class="bg-white">
                                    @foreach ($pencatatanStok as $pencatatan)
                                        <tr class="text-sm border-b hover:bg-gray-50">
                                            ...
                                            <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">{{ $pencatatan->satuan }}</td>
                                            <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">{{ $pencatatan->hargaSatuan }}</td>
                                            <td class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">{{ $pencatatan->totalHarga }}</td>
