                    ...
                    <div class="p-6 pb-0 m-6 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        ...
                        <div class="flex-auto px-0 pt-0 pb-2">
                            ...
                            @endif
                                ...
                                <form action="{{ route('pegawai.store') }}" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-7 items-center w-full mb-0 align-top border-collapse">
                                    @csrf
                                    ...
                                    <div>
                                        ...
                                        <input type="number" name="nomor_telepon" id="nomor_telepon" value="{{ old('nomor_telepon') }}" required
                                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                    ...
                                    <div>
                                        ...
                                        <input type="string" name="email" id="email" value="{{ old('email') }}" required
                                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                    ...
                                    <div>
                                        ...
                                        required
                                        class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5"
                                        placeholder="Masukkan alamat rumah pegawai">{{ old('alamat') }}</textarea>
                                        @error('alamat')
                                            <p class="mt-1 text-xs text-red-600">{{ $message }}</p>
                                        @enderror
                                    </div>
                                    ...
                                    {{-- Konfirmasi Password --}}
                                    <div>
                                        <label for="password_confirmation" class="block mb-2 text-base font-medium">Konfirmasi Password</label>
