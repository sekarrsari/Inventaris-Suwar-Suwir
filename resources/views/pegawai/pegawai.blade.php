                ...
                <div
                    ...
                    <div class="p-6 pb-0 mb-0 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <div class="flex justify-between items-center mt-3 mb-12">
                            <h3 class="text-4xl text-gray-800 font-bold">Manajemen Pegawai</h3>
                            <div class="flex items-center">
                                @can('create_pegawai')
                                {{-- Tombol Tambah Pegawai --}}
                                <button type="button" onclick="window.location.href='./pegawai/create'"
                                    ...
                                    @forelse ($dataPegawai as $gawai)
                                        <tr class="text-sm border-b hover:bg-gray-50">
                                            ...
                                            <td
                                                ...
                                                class="px-6 py-3 align-middle bg-transparent border-b whitespace-nowrap shadow-transparent">
                                                {{-- Tombol Detail (Show) --}}
                                                {{-- <a href="{{ route('pegawai.show', $gawai->id) }}"
                                                ...
                                                @canany(['edit_pegawai', 'delete_pegawai'])
                                                {{-- Tombol Edit --}}
                                                @can('edit_pegawai')
                                                <a href="{{ route('pegawai.edit', $gawai->id) }}"
                                                ...
                                                @can('delete_pegawai')
                                                <button type="button"
                                                    onclick="showDeleteModal('{{ route('pegawai.destroy', $gawai->id) }}')"
