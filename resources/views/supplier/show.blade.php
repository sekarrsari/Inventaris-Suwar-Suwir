            ...
            <div class="flex-none w-full max-w-7xl px-3 py-6">
                <div
                    ...
                    <div class="p-6 pb-0 m-6 border-b-0 border-b-solid rounded-t-2xl border-b-transparent">
                        <h2 class="text-3xl font-bold mb-9">Detail Data Supplier {{ $dataSupplier->nama }}</h2>

                        <div class="flex-auto px-0 pt-0 pb-2">
                            <div class="p-0 overflow-x-auto">

                                <form action="{{ route('supplier.store', $dataSupplier->id) }}" method="post" class="grid grid-cols-1 md:grid-cols-2 gap-7 items-center w-full mb-0 align-top border-collapse">
                                @csrf
                                @method('PUT')
                                    ...
                                    <div>
                                        ...
                                        <input type="text" name="namaSupplier" id="namaSupplier" value="{{ old('namaSupplier', $dataSupplier->namaSupplier) }}" disable
                                    ...
                                    <div>
                                        <label for="bahan" class="block mb-2 text-base font-medium">Bahan
                                            Baku</label>
                                        <input type="text" name="bahan" id="bahan" value="{{ old('bahan', $dataSupplier->bahan) }}" disable
                                            class="bg-gray-50 border border-gray-300 text-sm rounded-lg block w-full p-2.5">
                                    </div>
