<!-- sidenav  -->
<aside
    class="fixed inset-y-0 flex flex-col w-full p-0 antialiased transition-transform duration-200 -translate-x-full bg-white border-0 shadow-xl max-w-64 ease-nav-brand z-990 xl:ml-6 xl:rounded-r-2xl xl:left-0 xl:translate-x-0" aria-expanded="false">
    <div class="h-19">
    ...
    <div class="items-center block w-auto max-h-screen overflow-auto h-sidenav grow basis-full">
        <ul class="flex flex-col pl-0 mb-0">
            ...
            @can('create_pegawai')
            <li class="mt-0.5 w-full">
                <a class="{{ $title === "Manajemen Pegawai" ? 'bg-blue-500/13 rounded-lg font-semibold text-black' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="./pegawai">
                    <div
                        class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <i class="relative top-0 text-sm leading-normal text-emerald-500 ni ni-badge"></i>
                    </div>
                    <span class="ml-1 duration-300 opacity-100 pointer-events-none ease">Manajemen Pegawai</span>
                </a>
            </li>
            @endcan
            ...
            <li class="mt-0.5 w-full">
                <a class="{{ $title === "Peramalan Pengadaan" ? 'bg-blue-500/13 rounded-lg font-semibold text-black' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="./peramalan">
                    <div
                        class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
            ...
            <li class="w-full mt-4">
                <h6 class="pl-6 ml-2 text-xs text-blue-700 font-bold leading-tight uppercase opacity-70">Akun</h6>
            </li>

            <li class="mt-0.5 w-full">
                <a class="{{ $title === "Profil Saya" ? 'bg-blue-500/13 rounded-lg font-semibold text-black' : '' }} py-2.7 text-sm ease-nav-brand my-0 mx-2 flex items-center whitespace-nowrap px-4 transition-colors"
                    href="./profil">
                    <div
                        class="mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-center stroke-0 text-center xl:p-2.5">
                        <i class="relative top-0 text-sm leading-normal text-indigo-600 ni ni-single-02"></i>
                    </div>
